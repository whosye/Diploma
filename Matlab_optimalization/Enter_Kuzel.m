...
save x_v x_v, save y_v y_v, save y_v y_v, save z_v z_v
...
A=[Fv;p(1);p(2);p(3);p(4);p(5);p(6);p(7);p(8);p(9);p(10);p(11);p(12);p(13);p(14);p(15);p(16);p(17);p(18);p(19);p(20);p(21)]%;p(22);p(23);p(24);p(25);p(26);p(27)];
fileID = fopen('Values_KUZEL.txt','a');
